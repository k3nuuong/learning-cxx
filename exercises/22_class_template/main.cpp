            ...
            for (unsigned int i1 = 0; i1 < shape[1]; ++i1) {
                for (unsigned int i2 = 0; i2 < shape[2]; ++i2) {
                    for (unsigned int i3 = 0; i3 < shape[3]; ++i3) {
                        ...
                        const unsigned int j0 = others.shape[0] == 1 ? 0 : i0;
                        const unsigned int j1 = others.shape[1] == 1 ? 0 : i1;
                        const unsigned int j2 = others.shape[2] == 1 ? 0 : i2;
                        const unsigned int j3 = others.shape[3] == 1 ? 0 : i3;
